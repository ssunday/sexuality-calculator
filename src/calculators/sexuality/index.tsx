  ...
  return (
    <>
      <p>
        ...
        sexualities, hopefully helping you figure out the right term. Whatever
        the results, only you can know and decide for certain. This is just to
        try to help.
      </p>
      <p>
        If you see an issue or have a suggestion, please make a pull request or
        issue on{" "}
